...
**Nine rows; two of them — row 3 and DEF-2 — were paid by the mandate-continuity change of
2026-08-03 and are struck through rather than deleted, so a reader can tell "paid" from "never
asked". Two of the remaining six are blocking: rows 4 and 5.** Previously five of eight.
